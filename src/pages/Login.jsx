...
const Login = () => {
    ...
    const handleLogin = ()=>{
        if(getUserData.Username === LoginName ){
            ...
            <form class="space-y-4">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input value={LoginName} name="username" type="text" onChange={(e)=>setName(e.target.value)} required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600" placeholder="Enter user name" />
              ...
              <div class="!mt-8">
                <button onClick={handleLogin} type="button" class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Log in
                </button>
              </div>

              <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <button onClick={()=>navigate('/signup')} class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</button></p>
            </form>
          </div>
