    ...
    <div className="mt-28">
      <div className="md:text-center max-w-2xl mx-auto">
        ...
        <p>
          ...
          experience. Learn how our distinct offerings can redefine your journey
          and empower you to accomplish more.
        </p>
      </div>
      <div className="mt-14">
        <div className="grid md:grid-cols-2 items-center gap-16">
          ...
          <div className="max-w-lg">
            ...
            <p>
              ...
              your unique needs. Our platform provides a wide array of features,
              ensuring you have the flexibility to personalize your journey.
            </p>
            <button
              type="button"
    ...
    <div className="mt-28 bg-gray-50 px-4 sm:px-10 py-12">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 items-center gap-8">
          ...
          <div>
            <h6 className="text-xl font-bold text-gray-300 mb-4">
              Testimonials
            </h6>
    ...
    <div className="mt-28 bg-gray-50 px-4 sm:px-10 py-12 space-y-6">
      <div className="md:text-center max-w-2xl mx-auto mb-14">
        ...
        <p>
          ...
          out of our services. If you don't see your question here, feel free to
      ...
      >
        ...
        <div className="pb-5 px-6">
          <p>
            ...
            lacinia. Proin aliquam turpis at erat venenatis malesuada. Sed
            ...
            purus in efficitur consequat. Fusce et tincidunt arcu. Curabitur ac
            lacus lectus. Morbi congue facilisis sapien, a semper orci facilisis
            in.
          </p>
        </div>
      </div>
